...
const message = `
Заходите в наше уютное местечко , где можно отдохнуть и пообщаться с многими хорошими людьми 🎈😏🎗
(Сервер недавно был создан) Общительные игроки , прикольный бот , присоединяйся к нам!💎🥈🏆
